# Working Session: Burgess / Semantic Spacetime / Promise Theory
*2026-03-04*
...
Spacetime music collection article maps directly onto the Frozen Kernel's
critique of RLHF rule enumeration: both argue that exhaustive rule
enumeration is brittle, and that geometric constraint is the correct
...
it never made them. An agent cannot make promises about another agent's
behavior — the Frozen Kernel makes promises on behalf of the architecture,
not the model.

Source: AI summary only. Verify against Burgess's Promise Theory papers
before committing to README.

Insertion point (pending verification): README Intellectual Lineage,
same location as Connection 1.
